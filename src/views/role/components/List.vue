    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        ...
        <el-table v-loading="isLoading" :data="roles" style="width: 100%">
            ...
            <el-table-column prop="center" label="操作" width="150px">
        ...
        <el-dialog
          ...
          width="30%">
          <!-- 将添加与编辑功能单独封装到组件中 -->
          <create-or-edit @success="handleSuccess" @cancel="handleCancel" :is-edit="isEdit" :role-id="roleId" :isShow="dialogVisible"></create-or-edit>
        </el-dialog>
    </el-card>
  </div>
</template>
